...
![https://serialmentor.com/dataviz/aesthetic-mapping.html](common-aesthetics-1.png)
...
![https://r4ds.had.co.nz/tidy-data.html#tidy-data-1](tidy-1.png)  
...
Note, there are many options for the placement of the legend other than “topright” that
you may want to use if the legend overlaps your bars. These include “bottomright”,
